        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 En un entorno educativo cada vez más digital, la producción de Recursos Educativos Digitales (RED) se ha convertido en una competencia fundamental para garantizar experiencias de aprendizaje significativas, inclusivas y de calidad. Esta unidad ofrece los fundamentos conceptuales y prácticos necesarios para diseñar y desarrollar materiales didácticos digitales eficaces, que respondan a las demandas pedagógicas actuales.
              
              p #[b ¡Prepárese para transformar la educación digital con recursos pedagógicos innovadores, accesibles y efectivos!]
